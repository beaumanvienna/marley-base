...
#set up debian build
cp build-debian/marley/debian/marley_*20.04.dsc build-debian/
cp build-debian/marley/debian/control\ ubuntu\ 20.04 build-debian/marley/debian/control 
